...
在用git工具将 https://github.com/hyperledger/fabric.git 克隆到本地时，可能由于项目较大的原因，总是出现各种各样的问题，所以索性在Github上面分析。

Fabric的项目代码个人感觉比较分散，没有像以太坊源码那样不同文件各司其职（可能由于我对源码不够熟悉），所以基于交易流程分析。
